...
var Dajaxice = {
    ...
    calcula_costes: function(callback_function, argv, custom_settings){
        Dajaxice.call('web.calcula_costes', 'POST', callback_function, argv, custom_settings);
    },

    grafico_mes: function(callback_function, argv, custom_settings){
        Dajaxice.call('web.grafico_mes', 'POST', callback_function, argv, custom_settings);
    },

    grafico_semana: function(callback_function, argv, custom_settings){
        Dajaxice.call('web.grafico_semana', 'POST', callback_function, argv, custom_settings);
    },

    updatewifis: function(callback_function, argv, custom_settings){
        Dajaxice.call('web.updatewifis', 'POST', callback_function, argv, custom_settings);
    },

    grafico_dia: function(callback_function, argv, custom_settings){
        Dajaxice.call('web.grafico_dia', 'POST', callback_function, argv, custom_settings);
    },

    conectarLectura: function(callback_function, argv, custom_settings){
        Dajaxice.call('web.conectarLectura', 'POST', callback_function, argv, custom_settings);
    },

    comprobarLectura: function(callback_function, argv, custom_settings){
