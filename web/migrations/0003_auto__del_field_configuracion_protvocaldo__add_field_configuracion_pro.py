...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Configuracion.protvolcado'
        db.add_column('web_configuracion', 'protvolcado',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Configuracion.emailvolcado'
        db.add_column('web_configuracion', 'emailvolcado',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Configuracion.frecuencia'
        db.alter_column('web_configuracion', 'frecuencia', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
        # Deleting field 'Alarmas.timepoincio'
        db.delete_column('web_alarmas', 'timepoincio')

        # Adding field 'Alarmas.tiempoinicio'
        db.add_column('web_alarmas', 'tiempoinicio',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 15, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Configuracion.protvolcado'
        db.delete_column('web_configuracion', 'protvolcado')

        # Deleting field 'Configuracion.emailvolcado'
        db.delete_column('web_configuracion', 'emailvolcado')


        # Changing field 'Configuracion.frecuencia'
        db.alter_column('web_configuracion', 'frecuencia', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding field 'Alarmas.timepoincio'
        db.add_column('web_alarmas', 'timepoincio',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 15, 0, 0)),
                      keep_default=False)

        # Deleting field 'Alarmas.tiempoinicio'
        db.delete_column('web_alarmas', 'tiempoinicio')
    ...
    models = {
        ...
        'web.alarmas': {
            ...
            'tiempoinicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 15, 0, 0)'}),
        ...
        'web.configuracion': {
            ...
            'frecuencia': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
