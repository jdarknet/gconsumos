...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alarmas.idcomsumos'
        db.add_column('web_alarmas', 'idcomsumos',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.PtdMedida'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Alarmas.idcomsumos'
        db.delete_column('web_alarmas', 'idcomsumos_id')
    ...
    models = {
        ...
        'web.alarmas': {
            ...
            'tiempofin': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 1, 18, 0, 0)'}),
            'tiempoinicio': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 1, 18, 0, 0)'}),
