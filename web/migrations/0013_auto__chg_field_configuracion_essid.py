...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Configuracion.essid'
        db.alter_column('web_configuracion', 'essid', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Configuracion.essid'
        db.alter_column('web_configuracion', 'essid', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        'web.alarmas': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idcomsumos': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['web.PtdMedida']", 'null': 'True', 'blank': 'True'}),
            'tiempofin': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 1, 26, 0, 0)'}),
            'tiempoinicio': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 1, 26, 0, 0)'}),
        ...
        'web.configuracion': {
            ...
            'essid': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'w_dhcp': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'web.ptdmedida': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'totaliza': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
