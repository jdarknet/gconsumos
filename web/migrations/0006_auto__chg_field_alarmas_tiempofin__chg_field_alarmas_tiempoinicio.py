...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Alarmas.tiempofin'
        db.alter_column('web_alarmas', 'tiempofin', self.gf('django.db.models.fields.TimeField')())

        # Changing field 'Alarmas.tiempoinicio'
        db.alter_column('web_alarmas', 'tiempoinicio', self.gf('django.db.models.fields.TimeField')())

    def backwards(self, orm):

        # Changing field 'Alarmas.tiempofin'
        db.alter_column('web_alarmas', 'tiempofin', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Alarmas.tiempoinicio'
        db.alter_column('web_alarmas', 'tiempoinicio', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'web.alarmas': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tiempofin': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 0, 0)'}),
            'tiempoinicio': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 0, 0)'}),
