...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PtdMedida', fields ['canal']
        db.create_unique('web_ptdmedida', ['canal'])


    def backwards(self, orm):
        # Removing unique constraint on 'PtdMedida', fields ['canal']
        db.delete_unique('web_ptdmedida', ['canal'])
