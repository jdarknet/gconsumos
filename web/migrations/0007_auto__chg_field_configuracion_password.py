...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Configuracion.password'
        db.alter_column('web_configuracion', 'password', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Configuracion.password'
        raise RuntimeError("Cannot reverse this migration. 'Configuracion.password' and its values cannot be restored.")
